...
db.developer.aggregate([
    ...
    {
        $match: {
            "Field.CLI_CAT_Field": "Dr. Jo Bean"
        }
    },
    {
        $project: {
...
// do this in mongo
mongo --eval db.developer.aggregate([
    {
        $lookup:
        {
            from: "developer_works_on",
            localField: "DEV_ID",
            foreignField: "DEV_Id",
            as: "Works_On"
        }
    ...
    },
    {
        ...
        {
            from: "pro_multimedia",
            localField: "Project.PRO_ID",
            foreignField: "PRO_MUL_ID",
            as: "Multimedia"
        }
    },
    {
        $match: {
            "Project.PRO_Name": "Project 1"
        }
    },
    {
        $project: {
